...
Key names are found in the header file [/usr/include/X11/keysym.h](https://cgit.freedesktop.org/xorg/proto/x11proto/plain/keysymdef.h) (remove the `XK_` prefix).
